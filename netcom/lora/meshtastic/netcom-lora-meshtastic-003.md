...
- ABCD的出现有先有后。比方说，先出现A，A能实现一些功能S1S2；过了几年出现B，B能实现一些功能S3S4；又过了几年有人想要实现S5，于是促进发明了C。等等等等。时至今日，ABCD齐备的时候有人想到能组合成T1，实现S1-S8。我觉得了解技术的发展脉络有助于理解技术的本质，昨天有[这一篇笔记](netcom-lora-meshtastic-history-001.md)可以参考。（昨天的笔记里面的ABCDEFGH指别的，不是这一篇的硬件ABCD）
