...
- 作用：
  - 规定 frontmatter 结构、时间戳规则、引用标准等等；
  - 规定模块的划分；
  - 规定内容的拓扑结构。
...
> 这是总地图，文件为根目录下的 module-map.md 文件。  
> 各分区地图可以参考各分区文件夹内的 map.md 文件。
...
> 特别是 Canonical Archive 区使用的原创图片，都放在这里。
...
> 有一些流程化操作，我都放在 Internal 仓库的 Dashboard 里面，方便我一键发布之类的。
